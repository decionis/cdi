...
import { DecionisCdiGateway } from "./DecionisCdiGateway";
...
function gatewayWith(orgId = "org-1") {
  ...
  return { httpClient, gateway: new DecionisCdiGateway(httpClient, orgId) };
}

describe("DecionisCdiGateway — organisation scoping", () => {
...
describe("DecionisCdiGateway — identifier encoding", () => {
...
describe("DecionisCdiGateway — response shaping", () => {
